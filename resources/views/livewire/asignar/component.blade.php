        ...
        <div class="widget widget-chart-one">
            ...
            <div class="widget-content">
                <div class="form-inline">
                    ...
                    @endif --}}
                    <a href="javascript:void(0)" class="btn btn-warning" wire:click.prevent="SyncAll()" type="button" class="btn btn-warning">Sincronizar Todos los
                        Permisos</a>
                    <a onclick="Revocar()" type="button" class="btn btn-warning">Revocar Todos</a>
                </div>
                <br>
