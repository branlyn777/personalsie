...
<body>
    ...
    <div class="container">
        ...
        <p>
            PRIMERA: ipsum <b>NOMBRE COMPLETO: {{$cont->name}} {{$cont->lastname}}</b> dolor sit amet <b>C.I.: {{$cont->ci}} </b> consectetur adipisicing elit, sed do eiusmod tempor 
        ...
        <p>
            SEGUNDA: ipsum dolor sit amet <b>SALARIO: {{$cont->salario}}</b> consectetur adipisicing elit <b>AREA DE TRABAJO: {{$cont->area}}</b> sed do eiusmod <b>CRAGO: {{$cont->cargo}}</b> tempor 
            incididunt <b>FECHA DE INICIO: {{\Carbon\Carbon::parse($cont->fechaInicio)->format('Y-m-d')}}</b> ut labore et dolore magna aliqua <b>FECHA DE FINALIZACION: {{\Carbon\Carbon::parse($cont->fechaFin)->format('Y-m-d')}}</b> Ut enim ad minim veniam, quis nostrud 
