...
class AttendancesController extends Component
{
    ...
    public function SalesByDate()
    {
        ...
        $timeacumleted= $this->Calcular_hora($os->entrada, $os->salida);
       /* if($os->employee=='Ernesto' && $os->fecha=="2022-08-02" )
        {
            dd($timeacumleted);
        }*/
        //validar si cumplio las horas 
        if($timeacumleted>'04:40:00' && $os->entrada > '08:00:00' && $os->salida != '00:00:00')
        {
              /*  if($os->employee=='Ernesto')
            {
                dd($timeacumleted);
            }*/
        $os->hcumplida='Cumplio';
    ...
    //metodo de sumar horas
    function Calcular_hora($hora1,$hora2)
    {
